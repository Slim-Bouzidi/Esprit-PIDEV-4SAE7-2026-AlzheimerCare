  ...
  template: `
    <div style="padding: 20px; text-align: center;">
      ...
      <div style="display: flex; flex-wrap: wrap; gap: 12px; justify-content: center; margin-top: 10px;">
        ...
        <button (click)="goToAidantDashboard()" style="padding: 12px 24px; background: #7c3aed; color: white; border: none; border-radius: 8px; cursor: pointer; font-weight: 500;">
          Accéder au Dashboard Aidant
        </button>
      </div>
    </div>
  `
