...
/**
 * Support-network patients (dispatch / network). Dedicated table so this module does not collide with
 * the main app {@code patient} entity.
 */
@Entity(name = "SupportNetworkPatient")
@Table(name = "support_network_patient")
@NoArgsConstructor
@AllArgsConstructor
@Builder
